  ...
  return (
    <section id="portfolio" className="relative py-24 px-4">
      <div className="max-w-[90%] md:max-w-[80%] mx-auto">
        ...
        >
          <button 
            className="px-8 py-4 w-full rounded-full bg-white/5 backdrop-blur-xl border border-white/20 text-white font-semibold hover:bg-white/10 hover:border-[#0EC3BF]/50 hover:shadow-[0_0_40px_rgba(14,195,191,0.3)] transition-all duration-300"
            style={{ fontFamily: 'Outfit, sans-serif' }}
          >
